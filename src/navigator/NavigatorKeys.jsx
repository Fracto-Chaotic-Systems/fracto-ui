...
export const ASSETS_SIMULATOR_SPLITTER_KEYS = {
  legend_key: KEY_ASSETS_SIMULATOR_LEGEND_SPLITTER_POS,
  main_key: KEY_ASSETS_SIMULATOR_SPLITTER_POS,
  steps_key: KEY_ASSETS_SIMULATOR_STEPS_SPLITTER_POS,
  section_key: KEY_ASSETS_SPLITTER_POS_PX,
