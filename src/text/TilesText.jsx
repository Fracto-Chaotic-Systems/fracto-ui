...
const GENERATOR_FOLDER = "tiles/generator";

export const KEY_TILES_OVERVIEW = `${TILES_FOLDER}/tiles_overview`;
export const KEY_TILES_SETTINGS = `${TILES_FOLDER}/tiles_settings`;
export const KEY_TILES_STATUS = `${TILES_FOLDER}/tiles_status`;
export const KEY_TILES_STATUS_EFFECTIVENESS = `${TILES_FOLDER}/tiles_status_effectiveness`;
export const KEY_TILES_LOGS = `${TILES_FOLDER}/tiles_logs`;
export const KEY_TILES_SIDEBAR_LOGS = `${TILES_FOLDER}/sidebar_logs`;
export const KEY_TILES_GENERATOR = `${TILES_FOLDER}/tiles_generator`;
...
export const KEY_TILES_GENERATOR_DONE_AT = `${GENERATOR_FOLDER}/tile_done_at`;
...
export const KEY_TILES_GENERATOR_AUTOMATION_OPERATION = `${GENERATOR_FOLDER}/automation_operation`;
export const KEY_TILES_GENERATOR_AUTOMATION_LEVEL = `${GENERATOR_FOLDER}/automation_level`;
export const KEY_TILES_GENERATOR_AUTOMATION_SHORTCODES = `${GENERATOR_FOLDER}/automation_shortcodes`;
export const KEY_TILES_GENERATOR_AUTOMATION_SAVE = `${GENERATOR_FOLDER}/automation_save`;
export const KEY_TILES_GENERATOR_AUTOMATION_JOB_TITLE = `${GENERATOR_FOLDER}/automation_job_title`;
export const KEY_TILES_GENERATOR_AUTOMATION_JOB_TASKS = `${GENERATOR_FOLDER}/automation_job_tasks`;
export const KEY_TILES_GENERATOR_AUTOMATION_JOB_CREATED = `${GENERATOR_FOLDER}/automation_job_created`;
export const KEY_TILES_GENERATOR_AUTOMATION_GO = `${GENERATOR_FOLDER}/automation_go`;
export const KEY_TILES_GENERATOR_AUTOMATION_STOP = `${GENERATOR_FOLDER}/automation_stop`;
export const KEY_TILES_GENERATOR_AUTOMATION_STOP_AFTER_JOB = `${GENERATOR_FOLDER}/automation_stop_after_job`;
export const KEY_TILES_GENERATOR_AUTOMATION_STATE = `${GENERATOR_FOLDER}/automation_state`;
export const KEY_TILES_GENERATOR_AUTOMATION_PROGRESS = `${GENERATOR_FOLDER}/automation_progress`;
export const KEY_TILES_GENERATOR_AUTOMATION_TASK = `${GENERATOR_FOLDER}/automation_task`;
export const KEY_TILES_GENERATOR_AUTOMATION_ATTEMPT = `${GENERATOR_FOLDER}/automation_attempt`;
export const KEY_TILES_GENERATOR_AUTOMATION_ERROR = `${GENERATOR_FOLDER}/automation_error`;
export const KEY_TILES_GENERATOR_AUTOMATION_COUNTDOWN = `${GENERATOR_FOLDER}/automation_countdown`;

export const APP_TILES_TEXT = {
  [KEY_TILES_OVERVIEW]: "tiles overview",
  [KEY_TILES_SETTINGS]: "tiles settings",
  [KEY_TILES_STATUS]: "tiles status",
  [KEY_TILES_STATUS_EFFECTIVENESS]: "cache effectiveness",
  [KEY_TILES_LOGS]: "tiles logs",
  [KEY_TILES_SIDEBAR_LOGS]: "logs",
  ...
  [KEY_TILES_GENERATOR_DONE_AT]: "completed",
  ...
  [KEY_TILES_GENERATOR_AUTOMATION_OPERATION]: "type",
  [KEY_TILES_GENERATOR_AUTOMATION_LEVEL]: "level",
  [KEY_TILES_GENERATOR_AUTOMATION_SHORTCODES]: "count",
  [KEY_TILES_GENERATOR_AUTOMATION_SAVE]: "save job",
  [KEY_TILES_GENERATOR_AUTOMATION_JOB_TITLE]: "title",
  [KEY_TILES_GENERATOR_AUTOMATION_JOB_TASKS]: "tasks",
  [KEY_TILES_GENERATOR_AUTOMATION_JOB_CREATED]: "created",
  [KEY_TILES_GENERATOR_AUTOMATION_GO]: "go",
  [KEY_TILES_GENERATOR_AUTOMATION_STOP]: "stop",
  [KEY_TILES_GENERATOR_AUTOMATION_STOP_AFTER_JOB]: "stop after the current job",
  [KEY_TILES_GENERATOR_AUTOMATION_STATE]: "state",
  [KEY_TILES_GENERATOR_AUTOMATION_PROGRESS]: "progress",
  [KEY_TILES_GENERATOR_AUTOMATION_TASK]: "task",
  [KEY_TILES_GENERATOR_AUTOMATION_ATTEMPT]: "attempt",
  [KEY_TILES_GENERATOR_AUTOMATION_ERROR]: "error",
  [KEY_TILES_GENERATOR_AUTOMATION_COUNTDOWN]: "generating tiles in",
};
