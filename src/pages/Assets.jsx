...
const SIDEBAR_LIST = [
  {
    ...
    section_code: ASSETS_OVERVIEW,
    right_pane: <AssetsOverview />,
  },
  { section_code: SIDEBAR_BREAKER },
  {
    title_key: KEY_VIDEO_ASSETS_GENERATOR,
    section_code: VIDEO_GENERATOR,
    right_pane: <AssetsVideoGenerator />,
  },
  {
    title_key: KEY_IMAGE_ASSETS_GENERATOR,
    section_code: ASSETS_GENERATOR,
    right_pane: <AssetsImageGenerator />,
  },
  {
    title_key: KEY_ASSETS_GALLERY_SIDEBAR,
    section_code: ASSETS_GALLERY,
    right_pane: <AssetsImageGallery />,
  },
  {
  ...
  { section_code: SIDEBAR_BREAKER },
  {
    title_key: KEY_ASSETS_LORE_SIDEBAR,
    section_code: ASSETS_LORE,
    right_pane: <AssetsLore />,
  },
  {
    title_key: KEY_ASSETS_LORE_STYLES_SIDEBAR,
    section_code: ASSETS_LORE_STYLES,
    right_pane: <AssetsLoreStyles />,
  },
  { section_code: SIDEBAR_BREAKER },
  {
    title_key: KEY_SIDEBAR_SETTINGS,
    section_code: ASSETS_SETTINGS,
    right_pane: <AssetsSettings />,
  },
  {
    title_key: KEY_SIDEBAR_STATUS,
    section_code: ASSETS_STATUS,
    right_pane: <AssetsStatus />,
  },
  {
    title_key: KEY_SIDEBAR_LOGS,
    section_code: ASSETS_LOGS,
    right_pane: <AssetsLogs />,
  },
];
