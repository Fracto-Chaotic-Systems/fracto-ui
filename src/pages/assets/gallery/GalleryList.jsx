...
export const GALLERY_TABLE_WIDTH_PX = ASSET_ID_WIDTH_PX + SCOPE_WIDTH_PX + 70;
...
export class GalleryList extends Component {
  ...
  render() {
    ...
    const table_data = asset_list.map((row, index) => {
      return {
        asset_id: <styles.NumericValue>{row.asset_id}</styles.NumericValue>,
    ...
    return (
      <styles.ScrollingInlineBlock style={table_style}>
        {table}
