...
export class GalleryRightPanel extends Component {
  ...
  render() {
    ...
    const upper_block_height = Math.round(rendered_height * 0.2);
    const focal_point = {
    ...
    const magnifier_style = { height: `${rendered_height * 0.7}px` };
    return [
      <styles.ScrollingBlock style={panel_style}>
        <CoolStyles.Block>
          <styles.NumericValue style={asset_id_style}>
            {asset.asset_id}
          </styles.NumericValue>
          ...
          <styles.FixedInlineBlock>
            ...
            <styles.InlineHover style={icon_style}>
              {send_to_icon}
            </styles.InlineHover>
          </styles.FixedInlineBlock>
        </CoolStyles.Block>
        <CoolStyles.Block style={legend_style}>
          <FractoLegend height_px={135} focal_point={focal_point} />
        </CoolStyles.Block>
