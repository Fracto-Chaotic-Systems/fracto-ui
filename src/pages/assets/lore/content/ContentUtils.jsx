...
import ContentStyleGrid from "./ContentStyleGrid.jsx";
...
export const on_update_content = (content, edit_key, value, update_content) => {
...
export const render_entry_text = (data_obj) => {
  ...
  return (
    <CoolStyles.InlineBlock style={CONTENT_DATA_WRAPPER}>
      <CoolInputText
...
export const render_source_text = (data_obj) => {
  ...
  return (
    <CoolStyles.InlineBlock style={{ lineHeight: "1.75rem" }}>
      <CoolInputText
...
export const render_style_grid = (data_obj) => {
  const { style_list, on_style_list_changed } = data_obj;
  return (
    <CoolStyles.InlineBlock style={CONTENT_DATA_WRAPPER}>
      <ContentStyleGrid
        style_list={style_list}
        on_style_list_changed={on_style_list_changed}
      />
    </CoolStyles.InlineBlock>
  );
};
