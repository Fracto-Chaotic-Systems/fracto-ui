...
import { KEY_STUDY_INLINES } from "../../text/StudyText.jsx";
import { update_dimensions } from "../PageUtils.jsx";
import { BAILIWICK_TYPE_INLINE } from "../Study.jsx";
...
export class StudyInline extends Component {
  ...
  render() {
    ...
    return [
      <styles.SectionTitle key={"study-minibrots-title"}>
        {AppText.get(KEY_STUDY_INLINES)}
      </styles.SectionTitle>,
      <div ref={container_ref}>
        <MinibrotPanel
          bailiwick_type={BAILIWICK_TYPE_INLINE}
