...
export class StudyFields extends Component {
   state = {
      rendered_width: 0,
      rendered_height: 0,
      interval: null,
   ...
   componentDidMount() {
      ...
      this.setState({
         ...
         frame_settings: AppSettings
            .get(KEY_STUDY_FIELDS_FRAME_SETTINGS),
         subscription: AppSettings
            .subscribe(KEY_STUDY_FIELDS_FRAME_SETTINGS, this.on_frame_settings_changed)
      })
   }
   ...
   render() {
      ...
      const splitter_keys = {
         legend_key: KEY_STUDY_FIELDS_LEGEND_SPLITTER_POS,
         main_key: KEY_STUDY_FIELDS_SPLITTER_POS,
         steps_key: KEY_STUDY_FIELDS_STEPS_SPLITTER_POS,
         section_key: KEY_STUDY_SPLITTER_POS_PX,
      }
      return [
         <styles.SectionTitle
            key={'study-overview-title'}>
            {AppText.get(KEY_STUDY_FIELDS)}
         </styles.SectionTitle>,
