...
export class GeneratorActiveState extends Component {
  ...
  render_context = () => {
    ...
    const tile =
      tile_index === tiles.length ? tiles[tile_index - 1] : tiles[tile_index];
    const context_style = {
    ...
    return (
      <CoolStyles.InlineBlock key={"tile-context"} style={context_style}>
        <div>
          <GeneratorContext tile={tile} on_plan_complete={this.context_ready} />
        </div>
        <div style={coords_style}>{render_coordinates(tile_center)}</div>
  ...
  render_generated = (tile_points) => {
    ...
    return (
      <CoolStyles.InlineBlock key={"tile-generated"} style={generated_style}>
        <div>
          <GeneratorTile
        ...
        <div style={short_code_style}>{tile.short_code}</div>
      </CoolStyles.InlineBlock>
    );
  };
  ...
  render() {
    ...
    return (
      <styles.CenteredBlock key={"active-state"}>
        {context}
        <styles.OneRemSpacer />
        {generated}
