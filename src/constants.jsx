...
export const TIME_AGO_LOCALE = import.meta.env.VITE_TIME_AGO_LOCALE || 'en'
export const BACKGROUND_FIELD_GRADIENT = "linear-gradient(280deg, #bbbbbb 0%, #eeeeee 50%, #ffffff 90%)"
