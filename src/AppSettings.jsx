...
export class AppSettings {
    ...
    page_settings_keys.forEach((key) => {
      if ("default_value" in AppSettings.setting_definitions[key]) {
        AppSettings.settings_data[key] =
          AppSettings.setting_definitions[key].default_value;
      } else {
  ...
  static persist_settings = (new_settings) => {
    ...
    all_new_keys
      .filter(
        (key) =>
          AppSettings.setting_definitions[key] &&
          AppSettings.setting_definitions[key].persist,
      )
      .forEach((key) => {
        ...
        switch (key_settings.data_type) {
          ...
          default:
            console.log(
              "persist_settings bad data_type",
              key_settings.data_type,
            );
            break;
        }
      });
  ...
  static load_settings = () => {
    const persist_key_names = Object.keys(
    ...
    new_settings_keys.forEach((key) => {
      ...
      switch (key_definition.data_type) {
        ...
        case TYPE_OBJECT:
          ...
          AppSettings.settings_data[key] = key_definition.no_copy
            ? new_settings[key]
