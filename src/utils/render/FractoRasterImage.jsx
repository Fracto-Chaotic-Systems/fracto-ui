...
export class FractoRasterImage extends Component {
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    const focal_x_changed =
      prevState.stored_values.focal_point.x !== this.props.focal_point.x;
    const focal_y_changed =
      prevState.stored_values.focal_point.y !== this.props.focal_point.y;
    const scope_changed = prevState.stored_values.scope !== this.props.scope;
    const width_px_changed =
      prevState.stored_values.width_px !== this.props.width_px;
    if (
      focal_x_changed ||
      focal_y_changed ||
      scope_changed ||
