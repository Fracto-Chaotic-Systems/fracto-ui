...
export const iteration_chart = (
  ...
  try {
    ...
    return <Scatter data={data_dataset} options={options} />;
  } catch (e) {
    return [e.message];
  }
};
...
export const escape_points_chart = (
  click_point,
  in_cardioid,
  animation_index = -1,
) => {
...
export const process_r_data = (
  orbital_points,
  Q,
  progress_offset = Math.PI / 4,
) => {
  if (!orbital_points) {
    return [];
  }
...
export const escape_r_theta_chart = (
  click_point,
  in_cardioid,
  animation_index,
) => {
