...
export class CoolTree extends Component {
  ...
  static defaultProps = {
    on_expand: CoolTree.on_expand_noop,
    on_select: CoolTree.on_select_noop,
  };
  ...
  render() {
    ...
    const { data, on_select, on_expand, expanded_keys, selected_keys } =
      this.props;
    const wrapper_style = {
    ...
    return (
      <CoolStyles.Block style={wrapper_style} ref={tree_ref}>
        <Tree
          // style={wrapper_style}
          treeData={[data]}
          onSelect={on_select}
