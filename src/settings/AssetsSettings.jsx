...
export const KEY_VIDEO_GENERATOR_CURRENT_VIDEO_ID = `${VIDEO_GENERATOR_FOLDER}/current_video_id`;
...
export const APP_ASSETS_SETTINGS = {
  ...
  [KEY_VIDEO_GENERATOR_LEGEND_SPLITTER_POS]: {
    ...
    default_value: 800,
    description:
      "Current position for the horizontal video generator legend splitter",
    persist: true,
  },
  ...
  [KEY_VIDEO_GENERATOR_CURRENT_VIDEO_ID]: {
    data_type: TYPE_NUMBER,
    default_value: 0,
    description: "Id of the video project to reopen on the video generator page",
    persist: true,
  },
  ...
  [KEY_ASSETS_DETECTOR_LEGEND_SPLITTER_POS]: {
    ...
    default_value: 800,
    description:
      "Current position for the assets detector horizontal legend splitter",
    persist: true,
  },
  [KEY_ASSETS_DETECTOR_STEPS_SPLITTER_POS]: {
    ...
    default_value: 200,
    description:
      "Current position for the assets detector vertical steps splitter",
    persist: true,
  },
  ...
  [KEY_ASSETS_LORE_SELECTED_CATEGORY_ID]: {
    ...
    default_value: 0,
    description:
      "The id of the most recently selected category for lore viewing and editing",
    persist: true,
  },
