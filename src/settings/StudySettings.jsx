...
export const KEY_STUDY_CIRCUITRY_FRAME_SETTINGS = `${CIRCUITRY_FOLDER}/frame_settings`;
...
export const APP_STUDY_SETTINGS = {
  ...
  [KEY_STUDY_POINTS_LEGEND_SPLITTER_POS]: {
    ...
    default_value: 500,
    description:
      "Current position for the study points horizontal legend splitter",
    persist: true,
  },
  [KEY_STUDY_POINTS_STEPS_SPLITTER_POS]: {
    ...
    default_value: 200,
    description:
      "Current position for the study points vertical steps splitter",
    persist: true,
  },
  ...
  [KEY_STUDY_FIELDS_LEGEND_SPLITTER_POS]: {
    ...
    default_value: 500,
    description:
      "Current position for the study fields horizontal legend splitter",
    persist: true,
  },
  [KEY_STUDY_FIELDS_STEPS_SPLITTER_POS]: {
    ...
    default_value: 200,
    description:
      "Current position for the study fields vertical steps splitter",
    persist: true,
  },
  ...
  [KEY_STUDY_MINIBROTS_LEGEND_SPLITTER_POS]: {
    ...
    default_value: 500,
    description:
      "Current position for the study minibrots horizontal legend splitter",
    persist: true,
  },
  [KEY_STUDY_MINIBROTS_STEPS_SPLITTER_POS]: {
    ...
    default_value: 200,
    description:
      "Current position for the study minibrots vertical steps splitter",
    persist: true,
  },
  ...
  [KEY_STUDY_NODES_LEGEND_SPLITTER_POS]: {
    ...
    default_value: 500,
    description:
      "Current position for the study nodes horizontal legend splitter",
    persist: true,
  },
  ...
  [KEY_STUDY_HYPERPLANE_LEGEND_SPLITTER_POS]: {
    ...
    default_value: 500,
    description:
      "Current position for the study hyperplane horizontal legend splitter",
    persist: true,
  },
  [KEY_STUDY_HYPERPLANE_STEPS_SPLITTER_POS]: {
    ...
    default_value: 800,
    description:
      "Current position for the study hyperplane vertical steps splitter",
    persist: true,
  },
  ...
  [KEY_STUDY_MERIDIANS_LEGEND_SPLITTER_POS]: {
    ...
    default_value: 500,
    description:
      "Current position for the study meridians horizontal legend splitter",
    persist: true,
  },
  [KEY_STUDY_MERIDIANS_STEPS_SPLITTER_POS]: {
    ...
    default_value: 200,
    description:
      "Current position for the study meridians vertical steps splitter",
    persist: true,
  },
  [KEY_STUDY_CIRCUITRY_FRAME_SETTINGS]: {
    data_type: TYPE_OBJECT,
    default_value: DEFAULT_FRAME_SETTINGS,
    description: "Frame settings of the study circuitry page",
    persist: true,
  },
  [KEY_STUDY_CIRCUITRY_SPLITTER_POS]: {
    data_type: TYPE_NUMBER,
    default_value: 500,
    description: "Current position for the study circuitry splitter",
    persist: true,
  },
  [KEY_STUDY_CIRCUITRY_LEGEND_SPLITTER_POS]: {
    data_type: TYPE_NUMBER,
    default_value: 500,
    description:
      "Current position for the study circuitry horizontal legend splitter",
    persist: true,
  },
  [KEY_STUDY_CIRCUITRY_STEPS_SPLITTER_POS]: {
    data_type: TYPE_NUMBER,
    default_value: 200,
    description:
