...
export const KEY_DATA_QUERIES_TAB = `${DATA_FOLDER}/queries_tab`
...
export const DATA_QUERIES = 'data_queries'
// Retained so installations with the former persisted section value can migrate cleanly.
...
export const APP_DATA_SETTINGS = {
   ...
   [KEY_DATA_QUERIES_TAB]: {
      data_type: TYPE_NUMBER,
      default_value: 0,
      description: 'selected table tab on the data queries page',
      persist: true,
   },
   [KEY_DATA_MYSQL_HOST]: {
      data_type: TYPE_STRING,
