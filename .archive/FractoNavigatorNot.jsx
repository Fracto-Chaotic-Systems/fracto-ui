...
export class FractoNavigatorNot extends Component {
  ...
  componentDidMount() {
    ...
    const upper_pane_position_str = localStorage.getItem(
      LS_UPPER_PANE_POSITION,
    );
  ...
  render_upper_panes = (width_px, height_px) => {
    ...
    return (
      <styles.LeftPaneWrapper style={pane_style} ref={upper_pane_ref}>
        {upper_pane_content}
  ...
  render() {
    ...
    const pane_style = { width: `${width_px}px`, height: `${height_px}px` };
    return (
      <styles.LeftPaneWrapper style={pane_style} ref={left_pane_ref}>
        {left_pane_content}
      </styles.LeftPaneWrapper>
    );
  }
